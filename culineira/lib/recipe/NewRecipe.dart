...
import 'package:culineira/recipe/newrecipe/index.dart';
            ...
            children: [
                  ...
                  Container(
                      ...
                      child: ClipOval(
                        child: SizedBox.fromSize(
                          ...
                          child: Image.asset(
                              'assets/image/icon/CreateNewRecipe.png',
                              fit: BoxFit.cover),
                        ),
                      )),
              ...
              Container(
                  ...
                  child: ClipOval(
                    child: SizedBox.fromSize(
                      size: const Size.fromRadius(18),
                      child: Image.asset('assets/image/icon/Add.png',
                          fit: BoxFit.cover),
                    ),
                  )),
            ],
                      ...
                      Container(
                          ...
                          child: ClipOval(
                            child: SizedBox.fromSize(
                              size: const Size.fromRadius(18),
                              child: Image.asset(
                                  'assets/storage/${_newRecipeList[index].recipe_url}',
                                  fit: BoxFit.cover),
                            ),
                          )),
                      SizedBox(
                          width: 80,
                          child: Text(_newRecipeList[index].recipe_name,
            ...
            child: Column(
              children: [
                SizedBox(
                    height: 80,
                    child: ClipRect(
                      child: Image.asset('assets/storyset/norecipe.png',
                          fit: BoxFit.cover),
                    )),
                Text("Sorry, no recipe available",
                    style: TextStyle(color: iconMainColor, fontSize: 12.5))
              ],
            ));
      }
    }
        ...
        child: Container(
            ...
            child: Column(children: [
              Container(
                  ...
                  child: const Text("New Recipes this week",
                      style: TextStyle(

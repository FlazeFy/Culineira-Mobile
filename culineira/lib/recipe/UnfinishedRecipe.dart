  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ExpansionTile(
        ...
        subtitle: const Text(
            'Your unfinished recipe will be automaticly delete after a week since it was created',
            style: TextStyle(fontSize: 12.5, color: Color(0xFF414141))),
        children: <Widget>[
          Container(
              height: 115,
                            ...
                            Container(
                                ...
                                child: ClipOval(
                                  child: SizedBox.fromSize(
                                    ...
                                    child: Image.asset(
                                        'assets/image/recipes/Buncis Tumis Tempe_1.png',
                                        fit: BoxFit.cover),
                                  ),
                                )),
                            const Text("Buncis Tumis",
